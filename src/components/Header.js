...
import stylesCss from "../styles/header.module.css"
...
const Navbar = () => {
  ...
  return (
    <header className={stylesCss.headerStyles}>
      <div className={stylesCss.topMenu}>
        <div>
      ...
      <div className={stylesCss.bottomMenu}>
        ...
        <div className={stylesCss.openingHours}>
          Godziny Otwarcia LOLACZ<br />
          Poniedziałek-Piątek: 8:00 - 16:00 potwierdzone info
        </div>
        {burger ? (
          <TestNav>
            {" "}
            <li>
              <Link activeClassName='activeMobileLink' to="/">Strona Główna</Link>
            </li>
            <li>
              <Link activeClassName='activeMobileLink' to="/o-firmie">O Firmie</Link>
            </li>
            <li>
              <Link activeClassName='activeMobileLink' to="/produkty">Nasze Produkty</Link>
            </li>
            <li>
              <Link activeClassName='activeMobileLink' to="/kontakt">Kontakt</Link>
            </li>
          ...
          <NavigationStyle>
            <li>
              <Link activeClassName='activeNavLink' to="/">Strona Główna</Link>
            </li>
            <li>
              <Link activeClassName='activeNavLink' to="/o-firmie">O Firmie</Link>
            </li>
            <li>
              <Link activeClassName='activeNavLink' to="/produkty">Nasze Produkty</Link>
            </li>
            <li>
              <Link activeClassName='activeNavLink' to="/kontakt">Kontakt</Link>
            </li>
          </NavigationStyle>
        )}
